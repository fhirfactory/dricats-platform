package net.fhirfactory.dricats.databus.notificationbus;

import net.fhirfactory.dricats.databus.DataBusServicesGroup;
...
import net.fhirfactory.dricats.model.messaging.interfaces.ILocalNotificationService;
...
public class NotificationDistributionServiceArquillianIT {
    ...
    public static class LocalNotificationServiceStub implements ILocalNotificationService {
        ...
        @Override
        public net.fhirfactory.dricats.model.messaging.NotificationObject peekNextNotification(net.fhirfactory.dricats.model.common.naming.QualifiedNameToken consumer) { return null; }
        @Override
        public NotificationObject pollNextNotification(net.fhirfactory.dricats.model.common.naming.QualifiedNameToken consumer) { return null; }
        @Override
        public NotificationSet pollNextNotification(net.fhirfactory.dricats.model.common.naming.QualifiedNameToken consumer, Integer size) { return null; }
    }
